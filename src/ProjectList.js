          ...
          <div>
            <div className="card lg:card-side bg-base-100 shadow-xl m-7">
              ...
              <div className="card-body">
                ...
                <p className="text-left">A Tinder-like social website that allows users to find new friends in their area! Built with a React Frontend and a Flask Backend.</p>
